...
public class CurveChartColuli2 extends View {
    public int mWidth;
    public int mHeight;
    ...
    public CurveChartColuli2(Context context) {
        super(context);
    }

    public CurveChartColuli2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    public CurveChartColuli2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public static class CurveChartBuilder {
        private static CurveChartColuli2 curveChart;
        private static CurveChartBuilder cBuilder;

        private CurveChartBuilder() {
        }

        public static CurveChartBuilder createBuilder(CurveChartColuli2 curve) {
            curveChart = curve;
