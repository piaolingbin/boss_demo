...
public class MyPieChartView extends PieChartView{
    ...
    protected MyPieChartRenderer pieChartRenderer;
    ...
    public MyPieChartView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        pieChartRenderer = new MyPieChartRenderer(context, this, this);
